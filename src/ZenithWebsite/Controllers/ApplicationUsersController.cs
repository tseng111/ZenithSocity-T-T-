        ...
        public async Task<IActionResult> Index()
        {
            ...
            foreach (var role in roles)
            {
                ...
                var users = from u in _context.Users
                            where u.Roles.Any(r => r.RoleId == role.Name)
                            select u;
                IList<string> usersInRole = new List<string>();
                foreach (var user in users)
                {
                    usersInRole = await _userManager.GetRolesAsync(user);
                }
                ViewData[role.Name + "Roles"] = usersInRole;
            }
